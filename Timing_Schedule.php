    ...
    <div class="container padding_remove">
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            <div class="bread-heading">
                <h3>Department Timings </h3>
            </div>
            <div class="bread-crumb pull-right">
                <ul>
                    <li><a href="index.html">Home</a></li>
                    <li><a href="Timing_Schedule.html">Timing Schedule</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
         <div class="bhoechie-tab-container departments">
                    ...
                    <div class="list-group">
                       ...
                       <a href="Timing_Schedule.html" class="list-group-item  active">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                           ...
                           <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Department Working Time !</h4> 
                                ...
                                <div class="table-elements">
                                    <table class="table table-bordered table-striped table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>Pediatric Surgery Department</td>
                                                <td>All Day</td>
                                                <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Anaesthetic and Crtical Care Department</td>
                                                <td>All Day</td>
                                                <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td>Gasteroenterology Department</td>
                                                <td>All Day</td>
                                                <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                <td>Urology Department</td>
                                                 <td>All Day</td>
                                              <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                                <td>6</td>
                                                <td>Nephrology Department</td>
                                                <td>All Day</td>
                                              <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>8</td>
                                                <td>Pediatrics and Neonatal Department</td>
                                                <td>All Day</td>
                                              <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                                <td>9</td>
                                                <td>Minimal Access Surgery Department</td>
                                                <td>All Day</td>
                                               <td>24 x 7</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>13</td>
                                                <td>Dermatology Department</td>
                                                <td>All Day</td>
                                                <td>9:00 AM - 8:00 PM</td>
                                            </tr>
                                            <tr>
                                                <td>14</td>
                                                <td>Paed. Endocrinology Department</td>
                                               <td>All Day</td>
                                                <td>9:00 AM - 8:00 PM</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>16</td>
                                                <td>Plastic Surgery Department</td>
                                                <td>All Day</td>
                                                <td>9:00 AM - 8:00 PM</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>18</td>
                                                <td>Chest Medicine Department</td>
                                                 <td>All Day</td>
                                                <td>9:00 AM - 8:00 PM</td>
                                            </tr>
                                            <tr>
                                                <td>19</td>
                                                <td>Surgical Oncology Department</td>
                                              <td>All Day</td>
                                                <td>9:00 AM - 8:00 PM</td>
                                            </tr>
                                            <tr>
                                                <td>20</td>
                                                <td>E.N.T Department</td>
                                                <td>All Day</td>
                                                <td>9:00 AM - 8:00 PM</td>
                                            </tr>
                                            <tr>
...
<!-- Mirrored from Asthahospital.org/Timing_Schedule.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:16 GMT -->
</html>
