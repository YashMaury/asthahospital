                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Medicine Department !</h4> 
                                    ...
                                    <div class="carousel slide" id="myCarousel">
                                        ...
                                        <div class="carousel-inner ach_slider" style="height:300px;">
                                            ...
                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/Medicine_Department.jpg">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    In Astha Hospital, Medicine deals with diagnosis, treatment, and prevention of disease.
                                    Medicine Department encompasses a variety of health care practices evolved to maintain and restore health by the prevention 
                                    and treatment of illness. Here in Astha Hospital, Contemporary medicine applies biomedical sciences, biomedical research, genetics, and 
                                    medical technology to diagnose, treat, and prevent injury and disease, typically through pharmaceuticals or surgery,
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <p style="text-align: justify;">
                                        • Removal of Illness<br>
                                • Deals with all type of Infections<br>
                                • Diagnose all types of Illness<br>
...
<!-- Mirrored from Asthahospital.org/Medicine_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:51 GMT -->
</html>
