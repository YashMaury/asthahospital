...
<!--                        <a href="Online_Bill_Payment.php" class="list-group-item">
                ...
                <div class="bhoechie-tab-content active">
                    <div class="col-sm-9 col-md-9 col-lg-9">
                           ...
                           <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Doctors OPD Timing !</h4>  

                        <div class="col-md-12 no-pad col-xs-12 col-sm-12 pull-left  padding_remove padding_btm">
