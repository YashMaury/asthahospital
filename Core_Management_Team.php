                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    <div class="bhoechie-tab-content active">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 tabrightsec">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 coremangmnt2">
                                <h4>Founder & Director</h4>
                                <p>Dr. Dhanesh Kr. Agrahari - M.S. | M.Ch (Pediatric Surgery)</p>
                                <span>
                                    Dr. Dhanesh Agrahari is a Senior Consultant in General Surgery, Laproscopic Surgery with a super specialised degree (M.Ch) in Pediatric Surgery.
                                    <br>
                                    He has more than 15 years experience in the field of Pediatric Surgery, Pediatric Urology and Pediatric Laproscopic Surgery.  
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 tabrightsec">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 coremangmnt2">
                                <h4>Founder & Director</h4>
                                <p>Dr. R. K. Sinha - M.D.</p>
                                <span>Dr. Rupam Kr. Sinha is a Senior Consultant who deals with all kinds of Chronic Pain, Neck Pain, Low Back Pain, 
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 tabrightsec">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 coremangmnt2">
                                <h4>Founder & Director</h4>
                                <p>Dr. Urmi Neogi - M.S. (Gynaecology)</p>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 tabrightsec">
                            <div class="col-sm-3 col-md-3 col-lg-3 padding_remove">
                                <img src="images/female-default.png" alt="image" width="100%" class="thumbnail">
                            </div>
                            <div class="col-sm-9 col-md-9 col-lg-9 coremangmnt2">
                                <h4>Founder & Director</h4>
