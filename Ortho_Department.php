        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="bread-crumb pull-right">
                <ul>
                    ...
                    <li><a href="Ortho_Department.html">Orthopedics Department</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 sec3sub1 left_remove">
                            ...
                            <ul style="background: #F8F8F8; font-weight: 400;">
                                ...
                                <li>Surgical Sports Medicine</li>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Orthopedics Department !</h4> 
                                    ...
                                    <div class="carousel slide" id="myCarousel">
                                        ...
                                        <div class="carousel-inner ach_slider" style="height:300px;">
                                            ...
                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/Ortho_Department.jpg">
                                            </div>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    In Astha Hospital, Orthopedic is the department concerned with conditions involving the musculoskeletal system. Here, Orthopedic surgeons use both surgical and
                                                ...
                                                <div class="pad">
                                                    <b>
                                                        <a href="About_Doctors.html" target="_blank" alt="Click Here For Doctor" class="team_head">
                                                            Dr. Pranay Bhushan Pandey - <span> DNB (Orthopedics) <br> | Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
                                                <div class="pad">
                                                    <b>
                                                        <a href="About_Doctors.html" target="_blank" alt="Click Here For Doctor" class="team_head">
                                                            Dr. Anurag Jaiswal - <span> M.S (Orthopedics) <br> | Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
...
<!-- Mirrored from Asthahospital.org/Ortho_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:50 GMT -->
</html>
