    ...
    <div class="container padding_remove">
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            <div class="bread-heading">
                <h3>Paed. Endocrinology Department</h3>
            </div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Paed. Endocrinology Department !</h4> 
                                    ...
                                    <div class="carousel slide" id="myCarousel">
                                        ...
                                        <div class="carousel-inner ach_slider" style="height:300px;">
                                            ...
                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/PedEndioc_Department.jpg">
                                            </div>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    Astha Hospital - Pediatric Endocrinology Department deals with disorders of the endocrine glands, 
                                     such as variations of physical growth and sexual development in childhood, diabetes and many more.
                                    </p>
...
<!-- Mirrored from Asthahospital.org/PediEndri_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:50 GMT -->
</html>
