        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="bread-crumb pull-right">
                <ul>
                    ...
                    <li><a href="Corporate_Tie_Ups.php">Corporate Tie-Up</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<!--                        <a href="Success_Stories.php" class="list-group-item">
                        ...
                        <a href="Corporate_Tie_Ups.php" class="list-group-item active">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                           ...
                           <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Corporate TPA | Companies Empanelment with Us !</h4> 
                                    ...
                                    <table class="table table-bordered table-striped table-responsive">
                                        <thead>
                                            <tr style="text-align: center">
                                                <th>Sr. No.</th>
                                                <th>TPA | Insurance Company Name</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>Family Health Plan Limited</td>
                                                
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Paramount Health Services</td>
                                               
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>Dedicated Health Services</td>
                                                
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>United Health Care - PAREKH</td>
                                               
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                <td>MD India Health</td>
                                            ...
                                            <tr>
                                                <td>7</td>
                                                <td>Medi Assist Health</td>
                                            
                                            </tr>
                                            <tr>
                                                <td>8</td>
                                                <td>Star Health and Allied</td>
                                            ...
                                            <tr>
                                                <td>17</td>
                                                <td>Kotak Mahindra General Insurance Co. Ltd.</td>
                                                
                                            </tr>
                                            <tr>
                                                <td>18</td>
                                                <td>Future Generali - Applied</td>
                                            ...
                                            <tr>
                                                <td>21</td>
                                                <td>SBI General - PARAMOUNT</td>
                                                
                                            </tr>
                                            <tr>
                                                <td>22</td>
                                                <td>FHPL - Universal Sompo</td>
