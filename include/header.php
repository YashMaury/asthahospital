        ...
        <header>
            <div class="navbar navbar-default navbar-fixed-top " role="navigation">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 padding_remove">
                            <!--<div class="col-sm-2 col-md-2 col-lg-2 header_topp padding_remove">-->
                            <!--    <ul>-->

                            <!--       <div class="fb-like" data-href="https://www.facebook.com/AsthahospitalMariahu" data-layout="standard" data-action="like" data-size="small" data-show-faces="false" data-share="true"></div>-->

                            <!--    </ul>-->
                            <!--</div>-->
                            <div class="col-sm-4 col-md-4 col-lg-4 header_topp padding_remove"
                                style="text-align: center;margin-top:7px;">
                                <strong> OPD No. </strong> +91-7052411443
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3 headertop2"
                                style="text-align: center;margin-top:7px;">
                                <strong> IPD No. </strong> +91-9838275766
                            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 topstrip1 padding_remove"></div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 topstrip2 padding_remove"></div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 topstrip3 padding_remove"></div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 topstrip4 padding_remove"></div>
                    </div>
                </div>
                <div class="container">
