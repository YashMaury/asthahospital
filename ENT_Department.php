        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="bread-crumb pull-right">
                <ul>
                    ...
                    <li><a href="ENT_Department.html">ENT Department</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Otorhinolaryngology - ENT Department !</h4> 
                            
                            <div class="row" id="slider">
                                <div class="col-sm-12 col-md-12 col-lg-12"  id="carousel-bounding-box">
                                    <div class="carousel slide" id="myCarousel">
                                        <!-- Carousel items -->
                                        <div class="carousel-inner ach_slider" style="height:250px;">

                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/ENT_Department.jpg">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    In Astha Hospital, Otorhinolaryngology deals with the conditions of the ear, nose,
                                    and throat (ENT) region. The specialty is often treated as a unit with surgery of the head and neck (otolaryngology–head
                                    and neck surgery, or OHNS). Here in this Department, Patients seek treatment from the specialist doctors for diseases
                                    of the ear, nose, throat, or base of the skull,
                                    and for the surgical management of cancers and benign tumors of the head and neck.
                                    </p>
                                                ...
                                                <div class="pad">
                                                    <b>
                                                        <a href="About_Doctors.html" target="_blank" alt="Click Here For Doctor" class="team_head">
                                                            Dr. Ashutosh Rai - <span> M.S. (ENT)  | Senior Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
                                                <div class="pad">
                                                    <b>
                                                        <a href="About_Doctors.html" target="_blank" alt="Click Here For Doctor" class="team_head">
                                                            Dr. Arvind Srivastava - <span> M.S (ENT) | Senior Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
                                ...
                                • Hearing Loss<br>
                                • Mastoiditis<br>
                                • Otitis Externa – outer ear or ear canal inflammation<br>
                                • Ear Surgery<br>
                                • Otitis media – middle ear inflammation<br>
                                • Sinusitis – Acute, Chronic<br>
                                • Rhinitis<br>
                                • Empty Nose Syndrome<br>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from Asthahospital.org/ENT_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:50 GMT -->
</html>
