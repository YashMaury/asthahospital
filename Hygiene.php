            ...
            <div class="bhoechie-tab-container departments">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 bhoechie-tab-menu">
                    <div class="list-group">
                        ...
                        <a href="Hygiene.html" class="list-group-item active">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Hygiene Department !</h4> 
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="row" id="slider">
                                <div class="col-sm-12 col-md-12 col-lg-12"  id="carousel-bounding-box">
                                    <div class="carousel slide" id="myCarousel">
                                        <img src="images/Gallery/Hygiene_Page.jpg" style="width:800px; height:400px;">
                                                                       
                                    </div> 
                                </div>
                                    </div><hr>
                                    <p style="text-align: justify; font-size:13.5px;  line-height:25px;">
                                        <span style="border-bottom: 2px solid red;">Hygiene Department</span> in Astha Hospital is driven in practicing conducive to maintaining health and preventing disease, especially through cleanliness.  We never compromise with the Health of the 
                                        Patient and hence half of the disease diagnoses, if we maintain the cleanliness in our surroundings. 
                                        
                                        </p>
                                        <p style="text-align: justify; font-size:13.5px;  line-height:25px;">
                                        Hence, Hygiene is the most important factor in Astha Hospital. We give high attention on the Cleanliness and hygienic environment of the Hospital besides treatment, hygienic maintenance of any hospital plays 
                                        a Pivotal role for the faster recovery of the Patient. For this, we have an entirely separate department for hygiene issues which not only takes care the hygiene of the Patient admitted to make them 
                                        feel fresh and energetic every day but also the hygiene of every corner of the Hospital.
                                        </p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="images/Gallery/Hygiene_Page1.jpg" alt="image" style="width: 100%;height: 220px;" class="thumbnail">
                                    
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="images/Gallery/Hygiene_Page2.jpg" alt="image" style="width: 100%;height: 220px;" class="thumbnail">
