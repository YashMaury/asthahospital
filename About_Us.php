            ...
            <div class="bhoechie-tab-container departments">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 bhoechie-tab-menu">
                    <div class="list-group">
                        ...
                        <a href="About_Us.html" class="list-group-item active">
                        ...
                        <a href="Why_Us-2.html" class="list-group-item">
                            <h4 class="fa fa-h-square fontawsme"></h4><span>Why Us Only</span>
                        </a>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Astha Hospital !</h4> 
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
...
Astha was started in 2020 in one of the best locations in the locality with a well qualified team of doctors specialized in all treatment modalities. It is Thane's first dedicated plastic and aesthetic surgery center. It was started because a dire need was felt to enhance the look of the already beautiful society. Here cosmetic surgical and non-surgical procedures are perform   with minimal hospital stay, less post operative pain, quicker return to activity and better leadership.
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <img src="images/Gallery/ICU_Page2.jpg" alt="image" style="width: 100%;height: 220px;" class="thumbnail">
                                    <h4> <strong style="font-size:17px">Care</strong></h4>
...
<!-- Mirrored from Asthahospital.org/About_Us.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:11:57 GMT -->
</html>
