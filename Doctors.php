...
<!--                                <li class="blue"><a href="Book_An_Appointment.php">Book an appointment</a></li>-->
                    ...
                    <div class="item_caption">
                         <p>
                                <strong style="color:crimson; font-size:15px; font-weight: 400;">Dr. Urmi Neogi</strong><br>
                               M.S. | (Gynae.)
                            </p>							
                    </div>
                </div>
...
<!--                                <li class="blue"><a href="Book_An_Appointment.php">Book an appointment</a></li>-->
                    ...
                    <div class="item_caption">
                        <p>
                                <strong style="color:crimson; font-size:15px; font-weight: 400;">Dr. Shubha Malviya</strong><br>
                               DCH |(Paediatrics)
                            </p>						
                    </div>
                </div>
...
<!--                                <li class="blue"><a href="Book_An_Appointment.php">Book an appointment</a></li>-->
                    ...
                    <div class="item_caption">
                          <p>
                                <strong style="color:crimson; font-size:15px; font-weight: 400;">Dr. Alpana Sharma</strong><br>
                             M.D. | (Anaesthesia)
                            </p>
