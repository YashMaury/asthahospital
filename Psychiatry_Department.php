        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="bread-crumb pull-right">
                <ul>
                    ...
                    <li><a href="Psychiatry_Department.html">Psychiatry Department</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Psychiatry Department !</h4> 
                            
                            <div class="row" id="slider">
                                <div class="col-sm-12 col-md-12 col-lg-12"  id="carousel-bounding-box">
                                    <div class="carousel slide" id="myCarousel">
                                        <!-- Carousel items -->
                                        <div class="carousel-inner ach_slider" style="height:220px;">

                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/Psychiatry%20_Department.jpg">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <p style="text-align: justify; font-size:13.5px; line-height: 23px;">
                                     In Astha Hospital, Psychiatry is the branch of medicine which completely devoted to the diagnosis, prevention, study, and treatment of mental disorders.
                                     These include various abnormalities related to mood, behaviour, cognition, and perceptions. 
                                    </p>
                                                ...
                                                <div class="pad">
                                                    <b>
                                                        <a href="About_Doctors.html" target="_blank" alt="Click Here For Doctor" class="team_head">
                                                            Dr. Vipul Mehrotra - <span>M.D. (Psychiatry) | Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
...
<!-- Mirrored from Asthahospital.org/Psychiatry_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:49 GMT -->
</html>
