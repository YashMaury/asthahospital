            ...
            <div class="bhoechie-tab-container departments">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 bhoechie-tab-menu">
                    <div class="list-group">
                        ...
                        <a href="Achievements.html" class="list-group-item active">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                   ...
                   <h4 style="font-size:16px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Look at Astha Hospital Achievements - Ohhh, Its Updating, No Worries, Till then you can have a look at our other Pages too !</h4> 
...
<!-- Mirrored from Asthahospital.org/Achievements.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:48 GMT -->
</html>
