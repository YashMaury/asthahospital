        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="bread-crumb pull-right">
                <ul>
                    ...
                    <li><a href="Dermatology_Department.html">Dermatology Department</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 sec3sub1 left_remove">
                            ...
                            <ul style="background: #F8F8F8; font-weight: 400;">
                                ...
                                <li>Immunodermatology</li>
                                <li>Teledermatology</li>
                                <li>Dermatoepidemiology</li>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Dermatology Department !</h4> 
                                    ...
                                    <div class="carousel slide" id="myCarousel">
                                        ...
                                        <div class="carousel-inner ach_slider" style="height:300px;">
                                            ...
                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/Dermatology_Department.jpg">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <p style="text-align: justify; font-size:13.5px; line-height: 23px;">
                                     In Astha Hospital, Dermatology Department deals with the skin, nails, hair and its diseases It is a specialty with both medical and surgical aspects. A dermatologist treats diseases,
                                     in the widest sense and some cosmetic problems of the skin, scalp, hair, and nails.
                                    </p>
                                                ...
                                                <div class="pad">
                                                    <b>
                                                        <a href="About_Doctors.html" target="_blank" alt="Click Here For Doctor" class="team_head">
                                                            Dr. Amrita Madnani - <span>M.D. (Dermatology) | Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
                                ...
                                • Dermatopathology<br>
                                • Immunodermatology<br>
                               • Teledermatology<br>
                               • Dermatoepidemiology<br>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from Asthahospital.org/Dermatology_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:50 GMT -->
</html>
