        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            ...
            <div class="bread-crumb pull-right">
                <ul>
                    ...
                    <li><a href="Social_Media_Coverage.html">Social Media</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12  padding_remove padding_btm">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 bhoechie-tab-menu">
                            ...
                            <h4 class="fa fa-user fontawsme"></h4><span>Press Release</span>
                                ...
                                <a href="Social_Media_Coverage.html" class="list-group-item active">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    <div class="row gallery clearfix">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                           <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Social Media Coverage !</h4> 
                        </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 sec3sub2">
                                    ...
                                    <center>
                                        <div class="fb-page" data-href="https://www.facebook.com/Asthahospitalallahabad" data-tabs="timeline" data-width="500" data-height="1000" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Asthahospitalallahabad" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Asthahospitalallahabad">Astha Hospital</a></blockquote></div>
...
<!-- Mirrored from Asthahospital.org/Social_Media_Coverage.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:20 GMT -->
</html>
