                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 bhoechie-tab">
                    ...
                    <div class="bhoechie-tab-content active">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                               ...
                               <h4 style="font-size:18px; color:red; border-bottom: 2px solid black; padding-bottom: 5px;">Welcome to the Plastic Surgery Department !</h4> 
                            
                             <div class="row" id="slider">
                                <div class="col-sm-12 col-md-12 col-lg-12"  id="carousel-bounding-box">
                                    <div class="carousel slide" id="myCarousel">
                                        <!-- Carousel items -->
                                        <div class="carousel-inner ach_slider" style="height:330px;">

                                            <div class="active item" data-slide-number="0">
                                                <img src="images/Department/Plastic_Surgery_Department.png" style="border:1px solid black;">
                                            </div>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <p style="text-align: justify; font-size:13.5px; line-height: 23px;">
                                     Plastic Surgery is the process of reconstructing or repairing parts of the body by the transfer of tissue, either in the treatment of injury or for cosmetic reasons.
                                    </p>
                                                 ...
                                                 <div class="pad">
                                                    <b>
                                                        <a href="#" alt="Click Here For Doctor" class="team_head" >
                                                            Dr. Sanjay Tiwari - <span>M.S. | M.Ch (Plastic Surgery) | Senior Consultant</span>
                                                        </a>
                                                    </b>
                                                </div>
...
<!-- Mirrored from Asthahospital.org/Plastic_Surgery_Department.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jul 2023 08:12:48 GMT -->
</html>
